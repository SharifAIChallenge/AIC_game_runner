...
COMPILE_DOCKER_YML_ROOT = os.path.join(PROJECT_ROOT, '/yml/'.strip("/"))
COMPILE_DOCKER_YML_LOG_ROOT = os.path.join(PROJECT_ROOT, '/yml_log/'.strip("/"))
...
GAME_DOCKER_COMPOSE_YML_ROOT = os.path.join(PROJECT_ROOT, 'yml')
