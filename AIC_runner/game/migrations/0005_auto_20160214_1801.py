    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dockerfile', models.FileField(upload_to=b'docker/dockerfiles', storage=django.core.files.storage.FileSystemStorage(), verbose_name='dockerfile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('tag', models.CharField(max_length=50, verbose_name='tag')),
                ('compiled_code', models.FileField(upload_to=b'server/compiled_code', storage=django.core.files.storage.FileSystemStorage(), verbose_name='compiled code')),
        ...
        migrations.AddField(
            model_name='competition',
            name='server',
            field=models.ForeignKey(verbose_name='server container', blank=True, to='game.ServerConfiguration', null=True),
        ),
        migrations.AddField(
            model_name='competition',
